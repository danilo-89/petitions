    ...
    "Country of Residence": {
        ...
        custom: function () {
            ...
            if (v.length >= 2 && v.length <= 100) {
                ...
                throw new Meteor.Error('wrong-value', 'Overview must be between 2 and 100 character long')
            }
        }
    },
    "City": {
        ...
        custom: function () {
            ...
            if (v.length >= 2 && v.length <= 75) {
                ...
                throw new Meteor.Error('wrong-value', 'City must be between 2 and 75 character long')
            }
        }
    },
    "Age": {
